...
public class ListUsersByLocationSpecification : Specification<User>
{
  public ListUsersByLocationSpecification( string? searchString, Guid? localityId, int page = 1, int pageSize = 10)
  {
