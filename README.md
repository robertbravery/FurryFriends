...
To update the database use this command from the Web project folder (replace `FurryFriends` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../FurryFriends.Infrastructure/FurryFriends.Infrastructure.csproj -s FurryFriends.Web.csproj
```
