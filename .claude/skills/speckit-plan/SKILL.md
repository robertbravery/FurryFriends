...
metadata:
  ...
  source: companion-standard:commands/speckit.plan.md
---
...
3. **Agent context update**:
   - Update the plan reference between the `<!-- SPECKIT START -->` and `<!-- SPECKIT END -->` markers in `` to point to the plan file created in step 1 (the IMPL_PLAN path)
